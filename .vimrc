...
if has("autocmd")
  ...
  filetype indent on
    ...
    autocmd FileType css,sass,html,json,python,haskell,lua,js,javascript set expandtab tabstop=4 shiftwidth=4 softtabstop=4 textwidth=79
    autocmd FileType html,tensorflow set expandtab tabstop=2 shiftwidth=2 softtabstop=2 textwidth=79
...
let b:syntastic_c_cflags = '-Ilib/ -Isrc/'
let b:syntastic_cpp_cflags = '-Ilib/ -Isrc/ -std=c++11'
let g:syntastic_cpp_compiler = 'g++-4.8'
let g:syntastic_c_compiler = 'g++-4.8'
